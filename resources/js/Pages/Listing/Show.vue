<template>
    <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
        ...
        <EmptyState class="md:col-span-7 flex items-center w-full" v-else
            ...
            <Box>
                ...
                <div>
                    ...
                    <input
                        ...
                        max="30"
                        step="0.1"
                        class="w w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
                    />
                    <label class="label">
                    ...
                    <div class="text-gray-600 dark:text-gray-300 mt-2">
                        <div class="text-gray-3">Your monthly payment</div>
